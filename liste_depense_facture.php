  ...
  <tr>
    <td> <table width="100%" height="33" border="1">
	 	        <tr  style="background-color: #F90">
  	             ...
  	             <td> Liste des Depenses Liées aux Factures </td>
                </tr>
            </table></td>
  </tr>
  <tr>
   ...
   $requet="SELECT * FROM depense WHERE nature='3' ORDER BY id_depense ASC";
    ...
    <table border="1">
	   ...
	   $exe=$pre->execute(array($donnee['caissier']));
		...
		?>
			 ...
			 <td><a href="modifier_depense_facture.php? num=<?php echo $donnee['id_depense'];?>"> Modifier </a></td>
			 <td><a href="suppression_depense_facture.php? num=<?php echo $donnee['id_depense'];?>"> Supprimer </a></td>
			</tr>
			<?php 
	    } ?>
	</table></td>
