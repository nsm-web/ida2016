  ...
  <tr>
    <td> <table width="100%" height="33" border="1">
	 	        <tr  style="background-color: #F90">
  	             <td width="62%" nowrap="nowrap"> <?php include('menu.php'); ?> </td>
  	             <td width="38%"> Liste des Produits Relatifs a un Rendez-Vous</td>
                </tr>
            </table></td>
  </tr>
  <tr>
...
$num=$_GET['num'];
   $requet="SELECT * FROM achete, produit where achete.num_prodt=produit.num_prodt AND achete.id_rdv=?";
    ...
    <table border="1">
	    ...
	    while ($donnee=$prepare->Fetch()){ ?>
			<tr><td><?php echo $donnee['id_rdv'];?></td>
			 ...
			 <td><a href="modifier_achete.php?num=<?php echo $donnee['id_rdv'];?>&id=<?php echo $donnee['num_prodt'];?>"> Modifier </a></td>
			 <td><a href="suppression_achete.php?num=<?php echo $donnee['id_rdv'];?>&id=<?php echo $donnee['num_prodt'];?>"> Supprimer </a></td>
			</tr>
			<?php 
	    } ?>
	</table></td>
