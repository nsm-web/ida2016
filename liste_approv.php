  ...
  <tr>
    <td> <table width="100%" height="33" border="1">
	 	        <tr  style="background-color: #F90">
  	             ...
  	             <td>   Liste des Approvisionnements 
</td>
                </tr>
            </table></td>
  </tr>
...
<?php
   $requet="SELECT * FROM concerne ORDER BY id_depense ASC";
	   ...
	   <?php
	    while ($donnee=$prepare->Fetch()){ ?>
			<tr><td><?php echo $donnee['id_depense'];?></td>
			 ...
			 <td><a href="modifier_approv.php? num=<?php echo $donnee['id_depense'];?>"> Modifier </a></td>
			 <td><a href="suppression_approv.php? num=<?php echo $donnee['id_depense'];?>"> Supprimer </a></td>
			</tr>
			<?php 
	    } ?>
	</table></td>
